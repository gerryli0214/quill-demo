...
import * as Parchment from '@parchment/parchment';
import {
  Blot,
  BlotConstructor,
...
export interface ExpandedOptions extends Omit<Options, 'theme'> {
...
class Quill {
  ...
  constructor(container: HTMLElement, options: Options = {}) {
    ...
    // @ts-ignore TODO: fix BlotConstructor
  ...
  setSelection(
    ...
    if (index == null) {
      // @ts-ignore https://github.com/microsoft/TypeScript/issues/22609
