import LinkedList from '@parchment/collection/linked-list';
  ...
  optimize(...args) {
    ...
    this.children.forEach(child => {
      ...
      if (childFormats.table !== nextFormats.table) {
        ...
        if (next) {
          // @ts-ignore TODO: parameters of optimize() should be a optional
          next.optimize();
        }
...
class TableContainer extends Container {
  ...
  balanceCells() {
    // @ts-ignore TODO: fix signature of ParentBlot.descendants
